...
export const ACTIVITES = [
  ...
  },
  {
    ...
    recit: "Quatre cents hectares de bassins peu profonds, la plus grande saline de l'île, et pas un touriste. Les sauniers travaillent comme leurs pères : on remplit, on attend que le soleil fasse le reste, on ratisse. La croûte craque sous le râteau et la lumière s'y accroche — en fin de journée l'ensemble vire au rose. On peut parler avec eux, Agus traduit. Les cars passent devant sans ralentir : il n'y a rien à vendre ici, c'est bien pour ça que c'est intact.",
    photos: [
