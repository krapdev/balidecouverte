 ...
 *
 * Ce bloc vivait dans une section jade à part, juste avant le
...
export const TARIFS = {
   ...
   */
  supplement:
    "Si vous logez dans l'est (Candidasa, Sidemen, Amed, Tulamben), le nord-centre (Jatiluwih, Munduk, Kintamani) ou le nord et nord-ouest (Lovina, Pemuteran), comptez 15 € par nuit pour mon hébergement et mes repas sur place.",
  nusaPenida:
