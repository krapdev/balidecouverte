...
export const EXPERIENCES = [
  {
    ...
    scene: "terraces",
    tag: "Culture",
    text: "Marché du matin avec la famille, préparation du bumbu Bali au mortier de pierre, puis déjeuner assis par terre chez l'habitant, au milieu des rizières.",
  },
  {
    id: "purification",
  ...
  },
  {
    ...
    scene: "plantation",
    tag: "Nature",
    text: "Écolodge en bois au cœur des plantations de café et de clous de girofle. Torréfaction au feu de bois le soir, lever de soleil sur les lacs jumeaux.",
  },
];
...
export const ROUTE = [
  ...
  },
  {
    ...
    text: "Le cœur du séjour : rizières, cuisine chez l'habitant, tissage songket, purification à la source. C'est ici qu'on ralentit.",
  },
  {
    days: "Jours 6–7",
