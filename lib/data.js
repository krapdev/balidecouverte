...
export const ACTIVITES = [
     ...
     n'allait les chercher. */
  {
    ...
    photos: [
      {
        scene: "plantation",
        brief: "plan large : le ficus qui enjambe la route, quelqu'un dessous pour l'échelle",
        alt: "Le grand ficus de Munduk enjambant la route",
        src: null,
      },
      {
        scene: "plantation",
        brief: "détail : l'enchevêtrement des racines aériennes",
        alt: "Les racines aériennes du grand ficus",
        src: null,
      },
      {
        scene: "terraces",
        brief: "le chemin qui y mène, entre girofliers et caféiers",
        alt: "Le chemin bordé de girofliers menant au grand ficus",
        src: null,
      },
    ],
    titre: "Le grand ficus",
  ...
  },
  {
    ...
    photos: [
      {
        scene: "terraces",
        brief: "plan large : les bassins au soleil rasant, l'étendue jusqu'à l'horizon",
        alt: "Les bassins de la saline de Pemuteran au soleil rasant",
        src: null,
      },
      {
        scene: "terraces",
        brief: "un saunier au travail, le râteau sur l'épaule",
        alt: "Un saunier ratissant le sel",
        src: null,
      },
      {
        scene: "dauphins",
        brief: "détail : la croûte de sel qui craque, la lumière dedans",
        alt: "Gros plan sur la croûte de sel",
        src: null,
      },
    ],
  ...
  },
  {
    ...
    photos: [
      {
        scene: "terraces",
        brief: "le sentier entre les rizières, au départ de Kastala",
        alt: "Le sentier de Kastala à travers les rizières",
        src: null,
      },
      {
        scene: "terraces",
        brief: "une ruelle du village, les maisons alignées",
        alt: "Une ruelle du village de Tenganan",
        src: null,
      },
      {
        scene: "wayang",
        brief: "le tissage du geringsing sur le métier",
        alt: "Le tissage du geringsing à Tenganan",
        src: null,
      },
    ],
  ...
  },
  {
    ...
    photos: [
      {
        scene: "dauphins",
        brief: "le bateau à balancier à l'aube, silhouette contre le ciel",
        alt: "Un bateau à balancier au lever du jour",
        src: null,
      },
      {
        scene: "dauphins",
        brief: "les mains sur le filet, la prise qui remonte",
        alt: "Les mains du pêcheur relevant son filet",
        src: null,
      },
      {
        scene: "plantation",
        brief: "le repas partagé avec la famille, après",
        alt: "Le repas partagé avec la famille du pêcheur",
        src: null,
      },
    ],
  ...
  },
  {
    ...
    photos: [
      {
        scene: "plantation",
        brief: "les mains qui tressent l'offrande, en gros plan",
        alt: "Des mains tressant une offrande de feuille de palme",
        src: null,
      },
      {
        scene: "plantation",
        brief: "la torréfaction du café sur le feu de bois",
        alt: "La torréfaction du café sur un feu de bois",
        src: null,
      },
      {
        scene: "terraces",
        brief: "le labour et la plantation du riz, pieds dans l'eau",
        alt: "La plantation du riz, pieds dans l'eau",
        src: null,
      },
    ],
    ...
    photos: [
      {
        ...
        alt: "Le théâtre d'ombres : marionnette découpée sur l'écran",
        src: null,
      },
      {
        scene: "wayang",
        brief: "le marionnettiste de profil, la lampe et les tiges",
        alt: "Le marionnettiste au travail derrière son écran",
        src: null,
      },
      {
        scene: "wayang",
        brief: "le gender et le rindik entre les mains d'un voyageur",
        alt: "Les mains d'un voyageur sur le rindik de bambou",
        src: null,
      },
    ],
  ...
  },
  {
    ...
    photos: [
      ...
      {
        scene: "plantation",
        brief: "le sentier entre cacaoyers et caféiers",
        alt: "Le sentier de marche entre les plantations",
        src: null,
      },
      {
        scene: "canyon",
        brief: "la source d'eau chaude, la vapeur au petit matin",
        alt: "La source d'eau chaude en fin de parcours",
        src: null,
      },
    ],
