...
export const VALEURS = {
  ...
  points: [
    ...
    },
    {
      ...
      /* ⚠️ Ce n'est pas une association constituée, et le texte doit le
         dire : « ce n'est pas une association officielle des guides
         actuellement, uniquement une entraide et union des guides
         indépendants » — ses mots. */
      texte: "Je travaille avec d'autres guides indépendants, francophones et anglophones. Ce n'est pas une association officielle : c'est une entraide. Quand je ne suis pas disponible, je passe le relais à quelqu'un que je connais.",
    },
    {
