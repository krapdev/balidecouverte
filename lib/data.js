  ...
  points: [
    {
      ...
      /* « Vous m'aidez à faire vivre ma famille » plutôt que « ce que
         ...
         La phrase sur la cour familiale n'est pas de l'ornement : elle
         dit ce que « famille » veut dire ici, et ce n'est pas ce que le
         mot recouvre en France. Le tri hita karana est un concept
         balinais documenté, nommé comme le sont le canang sari ou le
         penjor ailleurs sur le site — on ne prête à Agus aucune parole
         qu'il n'aurait pas dite, on nomme une chose de son pays. */
      court: "Vous m'aidez à faire vivre ma famille — pas une commission d'intermédiaire. Ici, on vit à plusieurs générations dans la même cour, autour du temple des ancêtres.",
      texte: "Vous m'aidez à faire vivre ma famille — comme vous faites vivre le chauffeur et les familles qui vous accueillent chez elles, et non une commission d'intermédiaire. À Bali, une maison n'est pas une maison mais une cour : plusieurs générations sous le même mur, un temple pour les ancêtres, des offrandes déposées chaque matin. Les Balinais appellent ça le tri hita karana, les trois causes du bonheur — l'entente avec le divin, avec les autres et avec la terre. Aucune ne tient sans les deux autres.",
    },
    {
